## Lifting Pure Functions using Functors
...
Here is a more complex example with several overloaded functions involved, which unfortunately does not involve the functor type class. I will replace this with an implementation including a functorial constraint as soon as I get eyes on an appropriate example:
