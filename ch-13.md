...
Typescript does support Haskell-style implicit type classes, but it does support simple name overloading. While there is a way to imitate the latter it leads to entangled and complex type definitions. Therefore I decided to resort to dictionary passing style, which basically means explicit type classes on the term level.
