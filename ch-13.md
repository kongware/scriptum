...
```
`len`, `head` and `reverse` all describe the structure of arrays, because they do not transform their values. This is the closest we can get to the essence of what constitutes a context.
