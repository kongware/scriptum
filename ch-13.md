...
This was a lot of theory. Let us implement a couple of functors and compose them, because functors do compose by design. I will show how this increment functon `x => x + 1` will be applied to an array structure may be yielded as the result of an asynchronous computation, provided there is a result at all:
