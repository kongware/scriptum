...
const fetch1 = delay(_ => Some([1, 2, 3])) (1000) ();
//                             ^^^^^^^^^ original array
const fetch2 = delay(_ => None) (1500) ();
//                        ^^^^ no array at all

const main1 = tMap(optMap(arrMap(inc))) (fetch1);
const main2 = tMap(optMap(arrMap(inc))) (fetch2);
...
All it takes to lift the pure `inc` function into an asynchrounous context that either contains an array of natural numbers or nothing at all is `tMap(optMap(arrMap(inc)))`.
