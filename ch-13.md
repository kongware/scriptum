...
A functor is a higher-order type constrcutor parameterized with a single type:
...
Now that we know what a context exactly is it is noteworthy that a type can have more than one context and thus more than one associated functor.
