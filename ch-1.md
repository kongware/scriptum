...
The second constraint renders functions deterministic. The latter is referred to as purity and will be described in a subsequent chapter of this functional programming course.
