...
const appmAppend = ({liftA2, append}) => tx => ty =>
  AppMonoid(liftA2(append) (tx.appm) (ty.appm));
...
main(AppMonoid([1, 2, 3]))
  (AppMonoid([10, 20, 30])); // AppMonoid([11, 21, 31, 12, 22, 32, 13, 23, 33])

main2(AppMonoid([1, 2, 3]))
  (appmEmpty({of: arrOf, empty: sumEmpty}) ()); // AppMonoid([1, 2, 3])
```
