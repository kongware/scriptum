...
After all the theory it is time to demonstrate functorial lifting using specific instance implementations. The following instance lifts a pure function into a context that may fail and do not return a result at all:
