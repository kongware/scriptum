...
`liftA4` works with any applicative functor. We can generalize the application pattern, because the applicative combination of contexts is static or known upfront respectively. Let us drop the constraints and rename a few arguments to draw attention to the essential computational structure:
...
This is just a nested application of binary functions in a left-associative manner. Here is the right-associative variant:
