...
SInce applicatives are essentially functors they compose, i.e. we can compose contexts and their effects:
...
const main = tAp(
  tMap(
    comp(optAp)
      (optMap(
        comp(arrAp) (arrMap(add))))) (tttx)) (ttty);

const main2 = tAp(
  tMap(
    comp(optAp)
      (optMap(
        comp(arrAp) (arrMap(add))))) (tttx)) (tttz);
...
const main3 = tAp(
  tMap(x_ => y_ =>
    optAp(
      optMap(x => y =>
        arrAp(
          arrMap(add) (x)) (y)) (x_)) (y_)) (tttx)) (ttty);
