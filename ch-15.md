...
When the computation comes upon the `None` case, no matter at which position, the whole applicative composition is short circuited and the pure function is never evaluated.
