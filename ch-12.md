...
Ad-hoc polymorphism is a middle ground between parametric polymorphism and normal types. The basic idea is that a function or value constructor must not know anything about its ad-hoc polymorphic arguments except for a particular aspect. An ad-hoc polymorphic fold function for instance knows how to fold a data structure, provided that data structure is `Foldable`, i.e. implements 
