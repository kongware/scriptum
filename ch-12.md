...
We can distinguish two major type systems. A structural type system determines type compatibility and equivalence by the type's actual structure. A type B is considered a subtype of another type A if B contains extra properties besides A's ones:
