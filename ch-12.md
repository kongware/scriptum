...
In this course we will use a technique called dictionary passing style, because Typescript only supports runtime name overlaoding - the most primitive form of ad-hoc polymorphism. While dictionary passing style is as expressive as type classes it comes at the price of making your code more verbose. They act like explicit type classes.
