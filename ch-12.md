...
If a value constructor takes more than one value the associated type is a product type. If a type constructor is associated with more than one value constructor it the underlying type is a sum type:
