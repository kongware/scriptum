...
`Iarray` is an immutable type based on our HAMT implementation. Working with a concrete implementation hopefully assists you in evolving a feeling for immutable types and how it affects the coding. `Iarray` has a pretty simple API:
