...
The array contains individual elements that may have a value (`Some(x)`) or not (`None`). In the latter case values are just omitted, because this corresponds to the non-deterministic effect of arrays.
