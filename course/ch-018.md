...
```
chainHigherOrderMonad(chainBaseMonad)

// computations of the above partially applied function yield the following nested values:
BaseMonadValue(HigherOrderMonadValue)
```
