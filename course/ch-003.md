...
A different perspective on function composition is its duality to functon application. While application is the elimination rule of the function type, composition is its introduction rule. You cannot dynamically create new functions but you can compose two existing ones to create a new one.
