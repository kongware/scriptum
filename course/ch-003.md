...
Abstraction over arity allows us to combine curried functions in various ways with only the underlying types acting as limiting. This is a huge win in terms of reusability. Reusing functions is not just a nice theoretical exercise anymore, but becomes the daily routine.
