...
By introducing immutable data structures in a language without purely functional data types we are able to program against stringent APIs in a principled manner. Doing without mutations makes things harder at the beginning, because it stops us from making short cuts, but we trade them for gains in the long run.
