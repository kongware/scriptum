...
The first point describes the notion of expressions as ordinary values and the second one as computations with a specific effect. Depending on what notion we pick we get completely different results:
