...
Maybe you have already noticed that the underlying mechanism of apllicative functors is function application rather than composition. Let us compare the corresponding types to illustrate this link:
