...
The function applicative encodes the notion of a computation with a common read-only environment. You can use it to implicitly thread configuration or other shared data throughout a composition, that is, without having to pass this argument explicitly:
