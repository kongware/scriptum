...
But the computation cannot be short circuited depending on a value:
...
We can ignore the argurguments but still have to go through the entire structure of the lambda: `_ => _ => _ => []`.
