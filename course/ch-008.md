...
Above all, primitive recursion has one worthwhile property: It guarantees that a recursive algorithm terminates. So instead of clinging to the mathematical definition of primitive recursion, I will therefore try to transfer this property to the programming world.
