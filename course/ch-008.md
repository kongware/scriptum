...
This is bare corecursion in its original form, because we work directly within the literal of the given type. A more abstract encoding but stil corecursion is defined by the `iterate` function:
