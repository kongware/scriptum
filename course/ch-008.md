...
Primitive (or natural) recursion is a form of recursion where at each iteration the overall problem is descomposed by the smallest or simplest possible instance of that problem. This limitation ensures that every recursive algorithms terminates, because it is guaranteed to hit the base case:
