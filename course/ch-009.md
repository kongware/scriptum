...
Concluding here the Fibonacci sequence as a pseudo-mutual-recursive algorithm. It requires some CPS transformation so it is a bit hard to follow if you are unfamiliar with this technique:
