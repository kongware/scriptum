...
```
It turns out that every valid ADT can be expressed in algebraic notation and the result of this expression is the cardinality of the type, i.e. how many inhabitants it has. The names of ADT classes simply reflect the arithmetic operation that is used to determine the cardinality of possible types of this class.
