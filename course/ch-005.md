...
What exactly is the algebra of algebraic data types? Algebraic comes from category theory but we can also interpret it to mean ordinary school algebra and come up with the following notation to precisely describe ADTs:
...
Let us see how we can express various ADTs with our algebraic notation:
