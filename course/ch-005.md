...
As opposed to object oriented programming data and behavior are strictly decoupled from one another in the functional paradigm. Functions are usually global, because they are stateless.

### Algebraic data types

ADTs are the fundamental means to construct custom data structures in functional programming. They are composable and may have recursive definitions. The next sections will introduce the basic ADTs and their mathematical foundation.
