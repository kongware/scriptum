...
Bar(123, null); // ouch
```
With data types that only can add information we inevitably wind up with inflexibe type hierarchies, which tend to be inadequate to model the real, chaotic world.
