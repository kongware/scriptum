...
A functional abstraction is lawful, if it adheres to one or more algebraic laws/properties. Here is a list of basic algebraic properties that are required by various algebraic structures:
