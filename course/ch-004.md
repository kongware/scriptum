...
```
The first example demonstrates the harm of over-enginereeing. There are numerous other examples. Recognizing the overuse of abstractions again separates the seasoned functional programmer from the novice.
