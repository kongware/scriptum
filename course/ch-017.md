...
```
We still have the nested context, which is the `[[]]` structure in this example. In the next sections I am going to introduce two principled combinators that solve the issue.
