...
Monads have inherited the property every function includes: Once defined recursively they are not stack safe. Monads were not monads if it was not for a monad which would offer such safety:
