...
The essentially monadic property of non-deterministic arrays is their ability to form different shapes. Since an array is a linear data type only the length can differ:
