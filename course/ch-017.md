...
The composition of monadic actions is called Kleisli compostion. Just like with ordinary function composition we distingiush the right-to-left and left-to-right Kleisli form:
