...
### Control flow and evaluation order respectively

TODO

* lambda calculus doesn't assume an evaluation strategy+
* different strategies are possible
* which one is pickes depends on the compiler
* example if/then/else expressions
* example function application and composition
* I/O example and outlook on monads
