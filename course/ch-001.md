...
Another way of thinking the functional paradigm facilitates and encourages to is equational reasoning. It begins with the simple arithmetic laws like associativity, commutativity and distributivity and continues with more complex laws associatived with certain computational structures and data types, like the identity, composition or homomorphism law.
