...
The functional paradigm renders both the learning process for novices and individual projects for advanced users harder up front but gets easier later on. The reason for this experience is that the paradigm forces you to not make shortcuts in exchange for future benefits like more predictable, more resilient and more reliable code. Sticking to all these rules imposed on you by math might be annoying in the short term but it will save you a lot of trouble in the long run.
