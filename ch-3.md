...
```Javascript
comp(comp(add)) (add) (1) (2) (3); // 6
const comp2 = comp(comp) (comp);

comp2(add) (add) (1) (2) (3); // 6
```
...
const sum = reduce(add) (0); // easy to partially apply
const main = comp(sqr) (sum); // easy to compose
